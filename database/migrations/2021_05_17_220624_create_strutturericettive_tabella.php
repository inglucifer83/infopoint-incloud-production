...
class CreateStrutturericettiveTabella extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('strutturericettive', function (Blueprint $table) {
            $table->id();
            $table->string('pathImage', 255)->nullable();
            $table->string('pathFile', 255)->nullable();
            $table->unsignedInteger('comune_id');
            $table->unsignedInteger('tipostrutturaricettiva_id');
    ...
    {
        Schema::dropIfExists('strutturericettive');
    }
}
