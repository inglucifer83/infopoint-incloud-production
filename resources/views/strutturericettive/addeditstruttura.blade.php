...
@section('title')
    @if($strutturericettive->id)
        Modifica Struttura Interesse: {{ $comuni->nomecomune }} - {{ $strutturericettive->denominazione }}
    @else
        Nuovo Struttura Interesse: {{ $comuni->nomecomune }}
    @endif
@endsection
@section('page-style')
        ...
        @endif
            <div class="row mt-4 mb-5">
                <div class="col-xl-6 col-lg-6 col-sm-6">
                    @if($strutturericettive->id)
                        <h1 class="text-primary title-infopoint">Modifica Struttura: {{ $comuni->nomecomune }}
                            - {{ $strutturericettive->denominazione }}</h1>
                            <h5>Ultimo Aggiornamento: {{ $strutturericettive->updated_at->format('d/m/Y G:i:s') }}</h5>
                    @else
                        <h1 class="text-primary title-infopoint">Nuova Struttura: {{ $comuni->nomecomune }}</h1>
                    @endif
                </div>
                <div class="col-xl-6 col-lg-6 col-sm-6 text-center">
                    <a href="/strutturericettive">
            ...
            <div class="widget-content widget-content-area border-top-tab px-5 bg-white">
                @if($strutturericettive->id)
                    <form class="form-input" action="{{ route('strutturericettive.update', $strutturericettive->id) }}"
                          method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="comune_id" value="{{ $comuni->id }}">
                        {{ method_field('PATCH') }}
                        @else
                            <form class="form-input" action="{{ route('strutturericettive.store') }}" method="POST"
                                ...
                                <div class="tab-content" id="borderTopContent">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="inputDenominazione"
                                                       ...
                                                       value="{{ $strutturericettive->denominazione?$strutturericettive->denominazione:'' }}">
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label for="inputFrazione">Frazione</label>
                                                <input type="text" class="form-control" name="inputFrazione"
                                                       id="inputFrazione" maxlength="60"
                                                       value="{{ $strutturericettive->frazione?$strutturericettive->frazione:'' }}">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="inputIndirizzo"
                                                       ...
                                                       value="{{ $strutturericettive->indirizzo?$strutturericettive->indirizzo:'' }}">
                                            </div>
                                            <div class="col-md-3 mb-4">
                                                <label for="inputLatitudine">Lat. (NN.NNNNNNN)*</label>
                                                <input type="text" class="form-control" name="inputLatitudine"
                                                       id="inputLatitudine"
                                                       value="{{ $strutturericettive->latitudine?$strutturericettive->latitudine:'' }}">
                                            </div>
                                            <div class="col-md-3 mb-4">
                                                <label for="inputLongitudine">Long. (NN.NNNNNNN)*</label>
                                                <input type="text" class="form-control" name="inputLongitudine"
                                                       id="inputLongitudine"
                                                       value="{{ $strutturericettive->longitudine?$strutturericettive->longitudine:'' }}">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-3 mb-4">
                                                <label for="tipoLuogo">Tipo Struttura*</label>
                                                <select id="tipoLuogo" name="tipoLuogo" class="form-control">
                                                    <option value="" selected>Seleziona...</option>
                                                    @foreach ($tipostrutturaricettiva as $tipostruttura)
                                                        <option
                                                            value="{{ $tipostruttura->id }}" {{ $tipostruttura->id == $strutturericettive->tipostrutturaricettiva_id ? 'selected' : '' }}>{{ $tipostruttura->descrizione }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="inputTelefono"
                                                       ...
                                                       value="{{ $strutturericettive->telefono?$strutturericettive->telefono:'' }}">
                                            </div>
                                            <div class="col-md-3 mb-4">
                                                <label for="email">Email</label>
                                                <input type="text" class="form-control" name="email" id="email" maxlength="120"
                                                       value="{{ $strutturericettive->email?$strutturericettive->email:'' }}">
                                            </div>
                                            <div class="col-md-3 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="responsabile"
                                                       ...
                                                       value="{{ $strutturericettive->responsabile?$strutturericettive->responsabile:'' }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <div class="widget-content widget-content-area">
                                                    ...
                                                    <div id="descrizioneEditor"
                                                              name="descrizioneEditor">{!! $strutturericettive->descrizione?$strutturericettive->descrizione:'' !!}</div>
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="widget-content widget-content-area">
                                                    ...
                                                    <textarea type="text" class="form-control" rows="4" id="note"
                                                              name="note">{{ $strutturericettive->note?$strutturericettive->note:'' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                    ...
                                    <div class="tab-pane fade" id="border-top-contact" role="tabpanel"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                @if($strutturericettive->pathImage)
                                                    <img src="{{ asset($strutturericettive->pathluoghiinteresse) }}"
                                                         alt="Foto Struttura Ricettiva">
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                @foreach($fotostrutturericettive as $fotostruttura)
                                                    <div class="ph-item col-md-4 mt-4">
                                                        <div class="card component-card_2">
                                                            ...
                                                            <div class="card-body">
                                                                <a href="{{ route('fotostrutturericettive.destroy', $fotostruttura->id) }}" class="del-foto-a btn btn-primary">Cancella</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                                ...
                                                <div class="statbox widget box box-shadow">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="style-3"
                                                            ...
                                                            <tbody id="tblorario">
                                                            @foreach ($aperturestrutturericettive as $aperture)
                                                            <tr role="row" class="files-item">
                                                                    ...
                                                                    <td class="text-center">
                                                                                ...
                                                                                <a href="{{ route('aperturestrutturericettive.destroy', $aperture->id)  }}"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="modalAddOrarioForm" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="strutturericettive_id" value="{{ $strutturericettive->id }}">
        ...
        @section('page-script')
            ...
            <script>
                ...
                $(document).ready(function(){
                    ...
                    $('#modalAddOrarioForm').on('submit', function(e){
                        ...
                        $.ajax({
                            type: "POST",
                            url:"/aperturestrutturericettive",
            ...
            <script>
                $(function () {
                    ...
                    @if($strutturericettive->id)
                    var curLocation = [{{ $strutturericettive->latitudine }}, {{ $strutturericettive->longitudine }}];
                    @else
                    var curLocation = [0, 0];
                    @endif
